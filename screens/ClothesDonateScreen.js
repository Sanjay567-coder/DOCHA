...
export default class ClothesDonateScreen extends Component {
  constructor(props) {
    super(props);
  ...
  showPopOut = () => {
    ...
    if (
      ...
      db.collection('clothes_donations/').add({
        userId: this.state.userId,
        name: this.state.firstName,
        phoneNo: this.state.number,
        adress: this.state.adress,
        description: this.state.discription,
        noOfClothes: this.state.noOfClothes,
      ...
      <View
        ...
        <ScrollView>
          ...
          <Text
            ...
            Details about your Clothes Donation
          </Text>

          <TextInput
            placeholder="Details of clothes"
          ...
          <TextInput
            placeholder="How many sets of clothes"
            value={this.state.noOfClothes}
            onChangeText={(text) => {
              this.setState({
                noOfClothes: text,
              });
