...
export default class ClothesDetailsScreen extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  getRecieverDetails() {
    ...
    db.collection("clothes_donations")
  ...
  addNotification = () => {
    var message =
      this.state.userName + " has shown interest in donating books";
          ...
          <Header
            leftComponent={
              <Icon
                ...
                type="feather"
                color="#ffffff"
                onPress={() => this.props.navigation.navigate('AllClothesDonations')}
              />
            }
            centerComponent={{
              text: "Clothes Donations for Charity",
              style: {
                color: "#ffffff",
                fontSize: RFValue(20),
                fontWeight: "bold",
        ...
        <View style={{ flex: 0.9 }}>
          ...
          >
            ...
            >
              ...
              >
                Old or New : {this.state.oldOrNew} Clothes
              </Text>
            </View>
          </View>
          <View
