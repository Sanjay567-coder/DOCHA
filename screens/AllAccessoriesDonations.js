...
export default class AllAccessoriesDonations extends Component {
  constructor() {
    super();
    this.state = {
  ...
  getRequestedBooksList = () => {
    this.donateRef = db
      .collection('accessories_donations')
      .onSnapshot((snapshot) => {
  ...
  renderItem = ({ item, i }) => {
    return (
      <ListItem
        key={i}
        title={item.name + ' Accessories Donation'}
        ...
        rightElement={
          <TouchableOpacity
            style={styles.button}
            onPress={() => {
              this.props.navigation.navigate('AccessoriesDetailsScreen', {
                details: item,
              });
            }}>
