...
export default class FreeEducationDetailsScreen extends Component {
  constructor(props) {
    super(props);
    this.state = {
      ...
      noOfStudents: this.props.navigation.getParam('details')['sponsorValue'],
      mobileNo: this.props.navigation.getParam('details')['phoneNo'],
      address: this.props.navigation.getParam('details')['adress'],
      description: this.props.navigation.getParam('details')['description'],
      standardOfStudents: this.props.navigation.getParam('details')['standard'],
      recieverName: '',
      recieverContact: '',
      recieverAddress: '',
          ...
          <View
            ...
            <View
              ...
              <Text
                ...
                No Of Students : {this.state.noOfStudents}
              </Text>
              <Text
                style={{
                  fontWeight: '400',
                ...
                Standard Of all Students : {this.state.standardOfStudents}
              </Text>
            </View>
          </View>
          <View
