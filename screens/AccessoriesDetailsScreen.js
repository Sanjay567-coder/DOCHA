...
export default class AccessoriesDetailsScreen extends Component {
  constructor(props) {
    super(props);
    this.state = {
      ...
      units: this.props.navigation.getParam('details')['units'],
  ...
  getRecieverDetails() {
    ...
    db.collection('accessories_donations')
      ...
      <View style={{ flex: 1 }}>
        <View style={{ flex: 0.1 }}>
          <Header
            ...
            centerComponent={{
              text: 'Accessories Donations for Charity',
              style: {
                color: '#ffffff',
                fontSize: RFValue(20),
                fontWeight: 'bold',
