...
export default class MoneyDetailsScreen extends Component {
  constructor(props) {
    super(props);
    this.state = {
      ...
      amountOfDonation: this.props.navigation.getParam('details')['amount'],
      recieverName: '',
      recieverContact: '',
      recieverAddress: '',
      ...
      <View style={{ flex: 1 }}>
        <View style={{ flex: 0.1 }}>
          <Header
            ...
            centerComponent={{
              text: 'Money Donations for Charity',
              style: {
                color: '#ffffff',
                fontSize: RFValue(20),
                fontWeight: 'bold',
          ...
          <View
            ...
            <View
              ...
              <Text
                ...
                Amount Of Donation : {this.state.amountOfDonation}
              </Text>
            </View>
          </View>
          <View
