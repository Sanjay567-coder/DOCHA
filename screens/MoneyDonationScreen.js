...
export default class MoneyDonationScreen extends Component {
  constructor(props) {
    super(props);
  ...
  showPopOut = () => {
    ...
    if (
      ...
      db.collection('money_donations/').add({
      ...
      <View
        ...
        <ScrollView>
          ...
          <Text
            ...
            Details about your Money Donation
          </Text>

          <TextInput
            placeholder="How Much Rupees"
